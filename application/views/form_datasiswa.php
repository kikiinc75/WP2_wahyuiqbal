...
<body bgcolor="orens">
	...
	<form action="<?= base_url('datasiswa/cetak'); ?>" method="post">
		<th colspan="3" align="center">
			<h2>Implementasi Model Prototipe Pada Digital Learning Management System (Di-Lemas)</h2>
		</th>
		<table width="500" align="center" border="1">
			<tr>
				<th colspan="3">Pengolahan Data siswa</th>
			</tr>
			<tr>
				<td>Nama</td>
				<td><input type="text" name="nama" size="25" maxlength="50" placeholder="Masukan nama">
			<tr>
				<td>NIS </td>
			...
			<tr>
				...
				<td><input type="text" name="tempat" size="10"><input type="date" size="30" name="ttl" /></td>
			</tr>
			<tr>
				<td>Agama</td>
				<td>
