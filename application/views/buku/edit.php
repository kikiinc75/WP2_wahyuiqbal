			...
			<div class="col-md-8">
				...
				<form action="<?= base_url() . 'buku/edit' ?>" method="post">
					...
					<div class="mb-2">
						...
						<input type="text" name="tahun_terbit" value="<?= $book->tahun_terbit ?>" id="tahun_terbit" class="form-control" placeholder="Tahun Terbit">
					...
					<div class="mb-2">
						...
						<input type="text" name="id_kategori" value="<?= $book->id_kategori ?>" id="id_kategori" class="form-control" placeholder="ID Kategori">
